...
- 상태 (2026-07-30): **공용 모델 서빙 가동 완료.** Qwen3.6-35B-A3B NVFP4 × **DP=4 (GPU 0-3)**,
...
- 서빙 용량 (2026-07-30 실측): **최대 1,508 출력 tok/s, 포화점 동시 64, 권고 동시성 44.**
  확장 효율은 1장→2장 1.95배, 2장→4장 2.09배로 선형 ([09](09-stress-test-results.md))
